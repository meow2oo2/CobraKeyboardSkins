...
local layoutName = Imports.name.layoutName.numer_26;
local baseStyle = Imports.baseStyle;


Imports.getHeight(device, orientation)
+ Imports.getLayout(device, orientation, "symbol_26")
+ Imports.preedit(app, device, orientation, theme)
+ Imports.toolbar(app, device, orientation, theme, Imports.toolbarAction["pinyin_26"])
...
+ Imports.keyboard.newAlphabeticButton(app, device, orientation, theme,
  ...
  + Imports.getSize(device, orientation, "symLastLowButton"),
)
+ Imports.keyboard.newAlphabeticButton(app, device, orientation, theme,
...
+ Imports.keyboard.newSystemButton(app, device, orientation, theme,
  ...
  + Imports.getSize(device, orientation, "sym26shift"),
  needUpper=true
)
+ Imports.keyboard.newSystemButton(app, device, orientation, theme,
  Imports.name.buttonName.backspaceButton,
  Imports.action(app)[layoutName].backspaceButton
  +  Imports.getSize(device, orientation, "sym26del")
)
+ Imports.keyboard.newSystemButton(app, device, orientation, theme,
